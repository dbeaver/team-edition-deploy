...
Download the desktop client for your platform: [**DBeaver Team Edition Desktop**](https://dbeaver.com/downloads-team/26.2.0/)
...
### Older versions:
- [26.1.0](https://github.com/dbeaver/team-edition-deploy/tree/26.1.0)
- [26.0.0](https://github.com/dbeaver/team-edition-deploy/tree/26.0.0)
