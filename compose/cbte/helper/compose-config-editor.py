...
nginx_http_volumes = [
	"./nginx/nginx.http.conf.template:/etc/nginx/conf.d/nginx.conf",
	"./nginx/cloudbeaver.locations:/etc/nginx/conf.d/cloudbeaver.locations"
	]
nginx_ssl_volumes = [
	"./nginx/nginx.https.conf.template:/etc/nginx/conf.d/nginx.conf",
	"./nginx/cloudbeaver.locations:/etc/nginx/conf.d/cloudbeaver.locations",
	"./nginx/ssl:/etc/nginx/ssl"
	]
nginx_le_volumes = [
	"./nginx/cloudbeaver.locations:/etc/nginx/conf.d/cloudbeaver.locations",
	"./nginx/nginx.le.conf.template:/etc/nginx/conf.d/nginx.conf",
	"./data/certbot/conf:/etc/letsencrypt",
	"./data/certbot/www:/var/www/certbot"
	]
