...
on step 3 and 4 of [Configuring and starting Team Edition cluster](https://github.com/dbeaver/team-edition-deploy/tree/main/compose#configuring-and-starting-team-edition-cluster) use `podman-compose` tools intead of `docker-compose` and on step 4 define compose file name:
```
